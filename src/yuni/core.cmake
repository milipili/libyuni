...
add_library(libyuni_core_static STATIC EXCLUDE_FROM_ALL ${srcs})
target_link_libraries(libyuni_core_static PUBLIC Threads::Threads)
target_include_directories(libyuni_core_static PUBLIC "..")

target_compile_features(libyuni_core_static PUBLIC
	cxx_attributes
	cxx_auto_type
	cxx_constexpr
	cxx_decltype
...
if (WIN32)
	target_compile_definitions(libyuni_core_static "/DUNICODE" "/D_UNICODE" "/D_USE_64BIT_TIME_T")
endif()
